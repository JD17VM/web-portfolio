const pageData = {
    about: "Since a young age, programming has been my passion. I've had the opportunity to dive into software development and teach programming. I specialize in both backend and frontend web development, working with a variety of technologies and quickly adapting to new tools. My versatility allows me to solve complex challenges and deliver highquality solutions. I'm driven by the constant evolution of the tech world, always eager to learn and implement innovations. Whether collaborating with teams or working independently, my goal is to grow both technically and professionally while contributing to meaningful projects.",
